...
[role="lead"]
強力なサイバー ボールトは、攻撃者が昇格された権限で環境にアクセスするための資格情報を持っている場合でも、高度な攻撃に耐えられる必要があります。
...
image:ontap-cyber-vault-connections.png["サイバー金庫への接続がないことを確認する"]

このスクリーンショットは、スナップショットを改ざんすることができないことを示しています。

image:ontap-cyber-vault-tamperproof-snapshots.png["スナップショットコピーが改ざんされないことを確認する"]
